        ...
        <nav className="sticky top-0 z-50 bg-card border-b border-border shadow-sm">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              <Link href="/tasks" className="text-xl font-serif font-bold text-primary">
                WMS
              </Link>
              <div className="flex gap-8">
                ...
                <Link href="/employees" className="text-sm hover:text-primary transition-colors">
                  Employees
                </Link>
                <Link href="/logs" className="text-sm hover:text-primary transition-colors">
                  Logs
                </Link>
